...
// Rutas del servidor
// -----------------------------------
app.use('/api/users', require('./BACKEND/users/routes/usuario.routes.js'));
app.use('/api/auth', require('./BACKEND/users/routes/auth.routes.js'));
app.use('/api/products', require('./BACKEND/products/routes/producto.routes.js'));
